          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Entrez Vos Infos De Connexion</h5>
                  ...
                  <div class="pt-1 mb-4">
                    ...
                    <button class="btn btn-dark btn-lg btn-block"   type="button"><a href="registerClient.php">Pas encore client?</a></button>
                  </div>
